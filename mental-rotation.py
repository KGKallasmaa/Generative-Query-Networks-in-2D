...
dataset = ShepardMetzler("./shepard_metzler_5_parts") ## <= Choose your data location
loader = DataLoader(dataset, batch_size=1, shuffle=True)

# Load model parameters onto CPU
state_dict = torch.load("./20_epoch_run/checkpoint_model_20.pth", map_location="cpu") ## <= Choose your model location

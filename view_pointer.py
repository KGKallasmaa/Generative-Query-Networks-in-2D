...
def generate_3_elem(x_dim, y_dim):
    ...
    locations = np.asarray([[48, 24, 80, 60], # upper
                            [24, 72, 60, 104], # left down
                            [72, 72, 104, 104]]) # right down
    ## for the 300
